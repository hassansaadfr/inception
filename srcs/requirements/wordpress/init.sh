...
wp core install --allow-root --path=/var/wordpress/ --url=https://hsaadaou.42.fr --title=ft_services --admin_user=$ADMIN_WP_USER --admin_password=$ADMIN_WP_PASS --admin_email=$ADMIN_WP_USER@$ADMIN_WP_USER.com
